...
Structure the input data to match the following format (please see the [Recommender Augmentation Folder](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation) for details.):
