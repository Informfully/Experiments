...
To calculate the article ranking shared in the prediction folder, please run the script `sample.py` located in the [Recommender Algorithm Folder](TBD) folder.
